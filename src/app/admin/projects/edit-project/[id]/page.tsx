    ...
    useEffect(() => {
        ...
        const fetchProjectData = async () => {
            try {
                ...
                const [projectData, typesData, styleData, locationData] = await Promise.all([
                    projectRes.json(),
                    typesRes.json(),
                    styleRes.json(),
                    locationRes.json()
                ...
                if (projectData.image) {
                    setPreviewImage(`${process.env.NEXT_PUBLIC_API_URL}/${projectData.image}`);
                }
                    ...
                    >
                        ...
                        <div className="mb-4 flex space-x-4">
                            <div className="w-full">
                                ...
                                />
                                {!previewImage && (
                                    <p className="text-sm text-gray-500 mt-1">Выберите новое изображение или оставьте текущее</p>
                                )}
                            </div>
