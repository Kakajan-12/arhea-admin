...
const ViewVacancy = () => {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                ...
                const response = await axios.get(`${process.env.NEXT_PUBLIC_API_URL}/api/vacancy/${id}`, {
                    headers: {
    ...
    const handleDelete = async () => {
        ...
        try {
            const token = localStorage.getItem('auth_token');
            await axios.delete(`${process.env.NEXT_PUBLIC_API_URL}/api/vacancy/${id}`, {
                headers: {
                    Authorization: `Bearer ${token}`,
                },
            });
            ...
            <div className="flex-1 p-10 ml-62">
                ...
                <div className="mt-8">
                    <div className="flex justify-between items-center mb-4">
                        <h2 className="text-2xl font-bold">View vacancy</h2>
                                ...
                                <Menu.Items
                                    ...
                                    <div className="py-1">
                                        <Menu.Item>
                                            {({active}) => (
                                                <button
                                                    onClick={() => router.push(`/admin/vacancy/edit-vacancy/${id}`)}
                                                    className={`${
                ...
                {showModal && (
                    <div className="fixed inset-0 flex items-center justify-center bg-black/40 z-50">
                        <div className="bg-white p-6 rounded shadow-md w-96">
                            <h2 className="text-lg font-bold mb-4">Remove vacancy</h2>
                            <p className="mb-6">Are you sure you want to delete this vacancy?</p>
