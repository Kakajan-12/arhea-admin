...
const EditStyle = () => {
    ...
    const [data, setData] = useState({ style_tk: '', style_en: '', style_ru: '' });
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                ...
                const response = await axios.get(`${process.env.NEXT_PUBLIC_API_URL}/api/project-style/${id}`, {
                    headers: {
    ...
    const handleSubmit = async (e: FormEvent) => {
        ...
        try {
            const token = localStorage.getItem('auth_token');
            await axios.put(`${process.env.NEXT_PUBLIC_API_URL}/api/project-style/${id}`, data, {
                headers: {
                    Authorization: `Bearer ${token}`,
                },
            });
    ...
    return (
        <div className="flex bg-gray-200 min-h-screen">
            ...
            <div className="flex-1 p-10 ml-62">
                <TokenTimer />
                <div className="mt-8">
                    <h1 className="text-2xl font-bold mb-4">Edit style</h1>
