...
const Numbers = () => {
    ...
    useEffect(() => {
        const fetchNumbers = async () => {
            try {
                ...
                const response = await axios.get(`${process.env.NEXT_PUBLIC_API_URL}/api/numbers`, {
                    headers: {
    ...
    const handleDelete = async () => {
        ...
        try {
            const token = localStorage.getItem('auth_token');
            await axios.delete(`${process.env.NEXT_PUBLIC_API_URL}/api/numbers/${selectedNumberId}`, {
                headers: {
                    Authorization: `Bearer ${token}`,
                },
            });
                                ...
                                <tr key={number.id}>
                                    ...
                                    <td className="py-4 px-4 border-b border-gray-200">
                                        <Link
                                            ...
                                            className="flex items-center bg px-3 py-1 rounded text-white w-fit"
                                        >
                                    ...
                                    <td className="py-4 px-4 border-b border-gray-200">
                                        <button
                                            ...
                                            className="flex items-center bg-red-600 px-2 py-1 text-white w-fit rounded"
                                        >
