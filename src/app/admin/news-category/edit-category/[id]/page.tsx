...
const EditCategory = () => {
    ...
    const [data, setData] = useState({ category_tk: '', category_en: '', category_ru: '' });
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                ...
                const response = await axios.get(`${process.env.NEXT_PUBLIC_API_URL}/api/news-category/${id}`, {
                    headers: {
    ...
    const handleSubmit = async (e: FormEvent) => {
        ...
        try {
            const token = localStorage.getItem('auth_token');
            await axios.put(`${process.env.NEXT_PUBLIC_API_URL}/api/news-category/${id}`, data, {
                headers: {
                    Authorization: `Bearer ${token}`,
                },
            });
